    ...
    return (
        ...
        <div className="flex-1 p-2 md:p-5">
          <a className="btn btn-ghost text-xl text-[#003EA4]">
            Auction<span className="text-[#FFD337]">Gellery</span>
          </a>
        </div>
        ...
        <div className="hidden md:flex space-x-8 w-[55%] text-sm justify-center items-center">
        ...
        <div className="flex-none p-2 md:p-5 space-x-3">
          {/* Cart */}
          <div className="dropdown dropdown-end">
            <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
